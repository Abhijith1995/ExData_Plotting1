...
constructPlot <- function()
{
  ...
  par(mfrow = c(2,2))
  with(finalData, {
      plot(dayTime, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
      plot(dayTime, Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
      plot(dayTime, Sub_metering_1, type = "n", ylab = "Enegery sub metering")
      lines(dayTime, Sub_metering_1)
      lines(dayTime, Sub_metering_2, col = "red")
      lines(dayTime, Sub_metering_3, col = "blue")
      legend("topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"), lty=c(1,1))
      plot(dayTime, Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
    })
